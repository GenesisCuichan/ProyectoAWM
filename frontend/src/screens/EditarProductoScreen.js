...
export default function EditarProductoScreen() {
  ...
  const deleteFileHandler = async (fileName, f) => {
    ...
    toast.success(
      "Imagen removida exitosamente. Da clic en actualizar para salvar"
    );
  };
  return (
    <Container className='small-container'>
      ...
      <h1>
        Editar producto <strong>{name}</strong>
      </h1>
      ...
      {loading ? (
        ...
        <Form onSubmit={submitHandler}>
          ...
          <Form.Group className='mb-3' controlId='slug'>
            <Form.Label>Ficha del producto</Form.Label>
            <Form.Control
              value={slug}
          ...
          <Form.Group className='mb-3' controlId='image'>
            <Form.Label>Archivo de la imagen</Form.Label>
            <Form.Control
              value={image}
          ...
          <Form.Group className='mb-3' controlId='imageFile'>
            ...
            {loadingUpload && <MsgCarga></MsgCarga>}
          </Form.Group>
          ...
          <div className='mb-3'>
            ...
            {loadingUpdate && <MsgCarga></MsgCarga>}
          </div>
        </Form>
      )}
    </Container>
